      ...
      <div className="container mx-auto px-4 flex h-16 items-center justify-between">
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 bg-skyline-glow rounded-lg blur-sm opacity-50 group-hover:opacity-75 transition-opacity"></div>
            <div className="relative p-1.5 rounded-lg bg-skyline-glow">
              <MapPin className="h-5 w-5 text-white" />
            </div>
          </div>
          <span className="bg-skyline-glow bg-clip-text text-transparent">
            Discover Adama
          </span>
